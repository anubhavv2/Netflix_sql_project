...
-- Q9) Find each year and the average number of content release in India on Netflix. 
...
-- Q12) Categorize content as 'Bad' if it contains 'kill' or 'violence' and 'Good' otherwise. Count the number of items in each category.
SELECT 
